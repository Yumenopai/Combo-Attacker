...
// コンストラクタ
PrimitiveRenderer::PrimitiveRenderer(ID3D11Device* device, const char* filename)
{
	...
	else
	{
		//ダミーテクスチャ生成
		D3D11_TEXTURE2D_DESC desc;
		GpuResourceUtils::CreateDummyTexture(device, 0xFFFFFFFF, shaderResourceView.GetAddressOf(), &desc);
	...
	D3D11_PRIMITIVE_TOPOLOGY primitiveTopology)
{
	...
	{
		DirectX::XMFLOAT2(0,		0),		//左上
		DirectX::XMFLOAT2(1,	0),		//右上
		DirectX::XMFLOAT2(0,		1),	//左下
		DirectX::XMFLOAT2(1,	1),	//右下
	};
